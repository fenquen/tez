...
public class WordCount extends TezExampleBase {
    ...
    public static class TokenProcessor extends SimpleProcessor {
        ...
        public void run() throws Exception {
            ...
            // 读取 INPUT 对应的源头 写入 SUMMATION 对应的目标
    ...
    private DAG createDAG(TezConfiguration tezConf,
        ...
        Vertex tokenizerVertex = Vertex.create(TOKENIZER, ProcessorDescriptor.create(TokenProcessor.class.getName())).addDataSource(INPUT, dataSourceDescriptor);
        ...
        DataSinkDescriptor dataSinkDescriptor = MROutput.createConfigBuilder(new Configuration(tezConf), TextOutputFormat.class, outputPath).build();
        ...
        Vertex summationVertex = Vertex.create(SUMMATION, ProcessorDescriptor.create(SumProcessor.class.getName()), numPartitions).addDataSink(OUTPUT, dataSinkDescriptor);
    ...
    @Override
    protected int runJob(String[] args,

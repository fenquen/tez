...
public class AMContainerMap extends AbstractService implements EventHandler<AMContainerEvent> {
    ...
    public AMContainerMap(ContainerHeartbeatHandler chh, TaskCommManagerInterface tal,
    ...
    public void handle(AMContainerEvent amContainerEvent) {
        AMContainer container = containerMap.get(amContainerEvent.getContainerId());
        if (container != null) {
            container.handle(amContainerEvent);
        } else {
    ...
    public boolean addContainerIfNew(Container container,
                                     ...
                                     int launcherId,
                                     int taskCommId) {
        AMContainer amc = createAmContainer(container, chh, tal, containerSignatureMatcher, context, schedulerId, launcherId, taskCommId, auxiliaryService);
    ...
    AMContainer createAmContainer(Container container,
        ...
        return new AMContainerImpl(container, chh, tal,

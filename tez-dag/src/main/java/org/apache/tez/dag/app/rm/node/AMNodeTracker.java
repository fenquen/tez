...
public class AMNodeTracker extends AbstractService implements EventHandler<AMNodeEvent> {
    ...
    public synchronized void serviceInit(Configuration conf) {
        ...
        nodeUpdatesRescheduleEnabled = conf.getBoolean(
    ...
    boolean registerBadNodeAndShouldBlacklist(AMNodeEventHandler amNodeEventHandler, int schedulerId) {
        return perSourceNodeTrackers.get(schedulerId).registerBadNodeAndShouldBlacklist(amNodeEventHandler);
    }
    ...
    public AMNodeEventHandler get(NodeId nodeId, int schedulerId) {

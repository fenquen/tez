...
public class AMNodeEventHandlerImpl implements AMNodeEventHandler {

    private static final Logger LOG = LoggerFactory.getLogger(AMNodeEventHandlerImpl.class);
    ...
    private static StateMachineFactory
            <AMNodeEventHandlerImpl, AMNodeState, AMNodeEventType, AMNodeEvent>
            stateMachineFactory =
            new StateMachineFactory<AMNodeEventHandlerImpl, AMNodeState, AMNodeEventType, AMNodeEvent>(
                    AMNodeState.ACTIVE)
    ...
    @SuppressWarnings("rawtypes")
    public AMNodeEventHandlerImpl(NodeId nodeId, int schedulerId, int maxTaskFailuresPerNode,
    ...
    protected static class ContainerAllocatedTransition implements
            SingleArcTransition<AMNodeEventHandlerImpl, AMNodeEvent> {
        @Override
        public void transition(AMNodeEventHandlerImpl node, AMNodeEvent nEvent) {
    ...
    protected static class TaskAttemptFailedTransition implements
            MultipleArcTransition<AMNodeEventHandlerImpl, AMNodeEvent, AMNodeState> {
        @Override
        public AMNodeState transition(AMNodeEventHandlerImpl node, AMNodeEvent nEvent) {
    ...
    protected static class TaskAttemptSucceededWhileBlacklistedTransition
            implements MultipleArcTransition<AMNodeEventHandlerImpl, AMNodeEvent, AMNodeState> {
        @Override
        public AMNodeState transition(AMNodeEventHandlerImpl node, AMNodeEvent nEvent) {
            node.numSuccessfulTAs++;
            return AMNodeState.BLACKLISTED;
    ...
    protected static class ContainerCompletedTransition
            implements SingleArcTransition<AMNodeEventHandlerImpl, AMNodeEvent> {

        @Override
        public void transition(AMNodeEventHandlerImpl amNode, AMNodeEvent amNodeEvent) {

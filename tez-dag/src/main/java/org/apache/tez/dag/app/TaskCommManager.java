...
public class TaskCommManager extends AbstractService implements TaskCommManagerInterface {

    private static final Logger LOG = LoggerFactory.getLogger(TaskCommManager.class);
     ...
     * Only for testing.
     */
    public TaskCommManager(TaskCommunicator taskCommunicator, AppContext appContext,
                           TaskHeartbeatHandler thh, ContainerHeartbeatHandler chh) {
        super(TaskCommManager.class.getName());
    ...
    public TaskCommManager(AppContext context,
                           TaskHeartbeatHandler thh, ContainerHeartbeatHandler chh,

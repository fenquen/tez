...
public class LegacySpeculator extends AbstractService {
    ...
    private final ConcurrentMap<TezTaskID, Boolean> runningTasks = new ConcurrentHashMap<>();
    ...
    private final ConcurrentMap<TezTaskAttemptID, TaskAttemptHistoryStatistics>
            runningTaskAttemptStatistics = new ConcurrentHashMap<>();
    ...
    protected void serviceStart() throws Exception {
        ...
        try {
            ...
            if (speculationBackgroundThread == null) {
                speculationBackgroundThread = new Thread(createThread(), "DefaultSpeculator background processing");
        ...
        return () -> {
            while (!stopped && !Thread.currentThread().isInterrupted()) {
                ...
                try {
                    ...
                    long nextRecompTime = speculations > 0 ? soonestRetryAfterSpeculate : soonestRetryAfterNoSpeculate;
